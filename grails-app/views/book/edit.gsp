...
<%@ page import="com.logansrings.booklibrary.Book" %>
<html>
    <head>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: bookInstance, field: 'author', 'errors')}">
                                    <g:select name="author.id" from="${com.logansrings.booklibrary.Author.list()}" optionKey="id" value="${bookInstance?.author?.id}"  />
                                </td>
                            </tr>
                ...
                <div class="buttons">
                    ...
                    <span class="button"><g:actionSubmit class="delete" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return warnBeforeDelete();" /></span>
                </div>
            </g:form>
        </div>
    </body>
